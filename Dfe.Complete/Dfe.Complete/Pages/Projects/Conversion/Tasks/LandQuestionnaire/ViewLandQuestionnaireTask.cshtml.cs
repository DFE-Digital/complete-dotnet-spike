...
namespace Dfe.Complete.Pages.Projects.Conversion.Tasks.LandQuestionnaire
{
    public class ViewLandQuestionnaireTaskModel : PageModel
    {
        ...
        public ViewLandQuestionnaireTaskModel(IGetConversionProjectByTaskService getConversionProjectByTaskService)
        {
        ...
        {
            Project = await _getConversionProjectByTaskService.Execute(Guid.Parse(ProjectId), ConversionProjectTaskName.LandQuestionnaire);
        }
    }
}
