...
namespace Dfe.Complete.Pages.Projects.Conversion.Tasks.StakeholderKickoff
{
    public class ViewStakeholderKickoffTaskModel : PageModel
    {
        ...
        public ViewStakeholderKickoffTaskModel(IGetConversionProjectByTaskService getConversionProjectByTaskService)
        {
        ...
        {
            Project = await _getConversionProjectByTaskService.Execute(Guid.Parse(ProjectId), ConversionProjectTaskName.StakeholderKickoff);
        }
    }
}
