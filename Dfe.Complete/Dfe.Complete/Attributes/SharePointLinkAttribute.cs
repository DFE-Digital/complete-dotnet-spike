...
namespace Dfe.Complete.Attributes
{
    public class SharePointLinkAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (!link.StartsWith("https://educationgovuk-my.sharepoint.com"))
            {
                var errorMessage = $"Enter an {displayName} in the correct format. SharePoint links start with 'https://educationgovuk.sharepoint.com' or 'https://educationgovuk-my.sharepoint.com/'";
                return new ValidationResult(errorMessage);
            }
